...
This was part of the NHERI GSC 2025 AI Challenge.
...
Contributions:
Lissette Iturburu: Conceptuabilization of the framework, coding,  hyperparameter tunning, data labelling; Xiaoyu Liu: Conceptuabilization of the framework, hyperparameter tunning. Naomi Rahman: hyperparameter tunning, data labelling: Tabitha Gibbs: conceptualizaiton. 


To train the neural networks, we used the data available here: https://github.com/alenjani/hurricane_damage_detection

<img width="9658" height="1559" alt="image" src="https://github.com/user-attachments/assets/5d901401-2dd4-45ad-85f2-5f325960fd2e" />
